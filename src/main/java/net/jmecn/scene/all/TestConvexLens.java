...
public class TestConvexLens extends Scene2D {
    ...
    public Result scene(float x, float y) {
        ...
        Result b = new Result( circleSDF(x, y, 0.5f, 0.2f, 0.35f), Color.BLACK, 0.2f, 1.5f, new Color(2.0f) );
        Result c = new Result( circleSDF(x, y, 0.5f, 0.8f, 0.35f), Color.BLACK, 0.2f, 1.5f, new Color(2.0f) );
