...
public class TestConcaveLens extends Scene2D {
    ...
    public Result scene(float x, float y) {
        ...
        Result b = new Result(    boxSDF(x, y, 0.5f, 0.5f, 0.0f, 0.2f, 0.1f), 0.0f, 0.2f, 1.5f, 4.0f );
        Result c = new Result( circleSDF(x, y, 0.5f, 0.12f, 0.35f), 0.0f, 0.2f, 1.5f, 4.0f );
        Result d = new Result( circleSDF(x, y, 0.5f, 0.87f, 0.35f), 0.0f, 0.2f, 1.5f, 4.0f );
