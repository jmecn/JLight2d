...
public class TestReflection2 extends Scene2D {
    ...
    public Result scene(float x, float y) {
        ...
        Result b = new Result(    boxSDF(x, y, 0.5f, 0.8f, TWO_PI / 16.0f, 0.1f, 0.1f), Color.BLACK, 0.9f);
        Result c = new Result(    boxSDF(x, y, 0.8f, 0.5f, TWO_PI / 16.0f, 0.1f, 0.1f), Color.BLACK, 0.9f);
